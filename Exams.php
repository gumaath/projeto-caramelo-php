...
<body>
    ...
    <div class="container mt-4 " style="width: 80%;"><!--Container filtros-->
    ...
    <div class="container d-flex justify-content-end mt-2" style="width: 80%;"><!--Container que segura os buttons-->
        <button class="btn btn-primary mx-2">Pesquisar</button>
        <button class="btn btn-outline-secondary">Limpar filtros</button>
    </div><!--Container que contem os buttons-->
